...
const AddStory = () => {
    ...
    useEffect(() => {
        const fetchCategories = async () => {
            try {
                const { data } = await axios.get("https://svalbardexperts.com/api/story/getallcategories", config)
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const { data } = await axios.post("https://svalbardexperts.com/api/story/addstory", formdata, config)
